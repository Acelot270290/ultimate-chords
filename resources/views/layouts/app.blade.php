...
<head>
  ...
  gtag('config', 'G-H19E108GJH');
    ...
    <!-- Flaticons -->
    <link href={{ url('public/assets/css/font/flaticon.css') }} rel="stylesheet">
    <!-- Swiper Slider -->
    <link href={{ url('public/assets/css/swiper.min.css') }} rel="stylesheet">
    <!-- Range Slider -->
    <link href={{ url('public/assets/css/ion.rangeSlider.min.css') }} rel="stylesheet">
    <!-- magnific popup -->
    ...
    <link href={{ url('public/assets/css/artist.css') }} rel="stylesheet">
    <link href={{ url('public/assets/css/song.css') }} rel="stylesheet">
    <!-- Google Fonts -->
                    ...
                    <div class="footer-contact">
                        ...
                        <ul>
                            <li class="fw-600"><span class="text-light-white">Call Us</span> <a href="tel:"
                                    class="text-custom-white">+(347) 123 456 789</a>
                            </li>
                            ...
                            <li class="fw-600"><span class="text-light-white">Join our twitter</span> <a href="#"
                                    class="text-custom-white">@munchbox</a>
                            </li>
